...
POWER = 2
NUM_WORKERS = 216
NUM_BANDS = 1              # 1 = pixel-by-pixel (continuous), no discrete bands
...
OUTPUT_DIR = Path('/data/chla_data_imputation_data_260125/sst_knn_filled_optimized')
NPY_CACHE_DIR = Path('/data1/user/lz/FNO_CBAM/data_for_agent_FNO_CBAM_H20/sst_knn_npy_cache_optimized')
